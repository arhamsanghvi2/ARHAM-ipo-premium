        ...
        <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '400px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>Live GMP Scraper — 6 Sources</p>
                </div>

                {/* Login Card — glass-panel class from globals.css */}
                <div className="glass-panel" style={{ padding: 'clamp(1.25rem, 4vw, 2rem)' }}>
                    <h2 style={{ fontWeight: '700', fontSize: '1.15rem', marginBottom: '0.2rem', color: 'var(--text-primary)' }}>Sign in</h2>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.82rem', marginBottom: '1.5rem' }}>Enter your credentials to access the live GMP dashboard</p>
                    ...
                    <div style={{ marginTop: '1.25rem', paddingTop: '1rem', borderTop: '1px solid var(--surface-border)', textAlign: 'center' }}>
                        <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                            Demo: <code style={{ fontFamily: 'monospace', background: 'var(--bg-secondary)', padding: '0.1rem 0.4rem', borderRadius: '4px' }}>admin</code> / <code style={{ fontFamily: 'monospace', background: 'var(--bg-secondary)', padding: '0.1rem 0.4rem', borderRadius: '4px' }}>admin</code>
                        </p>
                    </div>
                </div>
            </div>
